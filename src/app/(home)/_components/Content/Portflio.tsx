...
export function Portfolio({ img, title, content, link }: PortflioProps) {
  ...
  return (
    ...
    >
      <div className="flex h-full w-full translate-y-[70%] flex-col gap-4 bg-[linear-gradient(rgba(0,0,0,0),rgba(0,0,0,0.2)_20%,rgba(0,0,0,1))] p-6 break-words transition duration-500 group-focus-within:translate-y-0 group-focus-within:delay-500 group-hover:translate-y-[0%] group-hover:delay-500 after:w-full after:group-focus-within:duration-0 hover:translate-y-0">
