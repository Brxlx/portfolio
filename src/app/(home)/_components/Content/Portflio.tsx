...
export function Portfolio() {
  return (
    <div className="group max-w-[35ch] overflow-hidden rounded-md bg-[url('/portfolio.jpg')] bg-cover p-[7rem_0_0] transition-transform duration-500 focus-within:scale-105 hover:scale-105">
